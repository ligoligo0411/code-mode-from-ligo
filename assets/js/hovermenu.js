...
$(function(){
	$.hovermenu('init',{
		buttons:{
			"tl":{icon:"icon-music", text:"背景音乐", callback: function(){autoPlay();}},
			"tr":{icon:"icon-pencil", text:"笔记本", callback: function(){window.open("../../功能页部分/笔记本/index.html","_blank");}},
			"bl":{icon:"icon-thumbs-up", text:"分享点赞", callback: function(){window.open("../../../网站分享/open.html","_blank");}},
			"br":{icon:"icon-user-md", text:"作者信息", callback: function(){window.open("../../功能页部分/作者信息/index.html","_blank");}}
		}
	});
